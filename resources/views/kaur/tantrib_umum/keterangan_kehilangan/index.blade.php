  ...
  <div class="row">
    <div class="col-lg-12">
      <ul class="breadcrumb">
        ...
        <li class="active">KAUR Tantrib & Umum - Keterangan Kehilangan</li>
      </ul>
    </div>
  </div>
  <div class="row">
    <div class="col-lg-12">
      ...
      <p>
        <a
          href="/dasbor/kaur-tantrib-dan-umum/keterangan-kehilangan/form-tambah"
...
@section('js')
  ...
  <script>
    var keterangan_kehilangan = $('#keterangan-kehilangan-table').DataTable({
      ajax: {
        url: '/dasbor/kaur-tantrib-dan-umum/keterangan-kehilangan/data',
        type: 'get'
      },
      datatype: 'json',
      columns: [
