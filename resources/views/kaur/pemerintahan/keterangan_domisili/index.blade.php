...
@section('content')
  <div class="row">
    <div class="col-lg-12">
      <h1 class="page-header">Keterangan Domisili</h1>
    </div>
  </div>
  <div class="row">
    <div class="col-lg-12">
      <p>
        <a href="/kaur-pemerintahan/keterangan-domisili/form-tambah" class="btn btn-sm btn-primary">
          <i class="fa fa-plus"></i> Tambah Data Keterangan Domisili
        </a>
      </p>
