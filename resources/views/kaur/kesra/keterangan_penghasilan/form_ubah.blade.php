  ...
  <div class="row">
    <div class="col-lg-12">
      <ul class="breadcrumb">
        ...
        <li><a href="#">KAUR Kesra - Keterangan Penghasilan</a></li>
    ...
    <div class="col-lg-12">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <div class="row">
            <div class="col-lg-12">
              <form action="/dasbor/kaur-kesra/keterangan-penghasilan/ubah/{{ $keteranganPenghasilan->id }}" method="post">
                <h4>
                  <b>
                    IDENTITAS PENDUDUK
                  </b>
                ...
                @section('nik')
                  <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="form-group {{ $errors->has('penduduk_id') ? 'has-error has-feedback' : '' }}">
                      ...
                      >
                        <option
                          value="{{ $keteranganPenghasilan->penduduk->nik }}"
                          selected="selected"
                        >
                          {{ $keteranganPenghasilan->penduduk->nik }}
                        </option>
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-6 col-md-6 col-xs-12">
                      ...
                      <input
                        ...
                        name="penghasilan"
                        class="form-control"
                        value="{{ $keteranganPenghasilan->penghasilan }}"
                      />
                  ...
                  <div class="row">
                    <div class="col-lg-12 col-md-12 col-xs-12">
                      ...
                      <textarea
                        ...
                        rows="5"
                        readonly
                      >{{ $keteranganPenghasilan->redaksi }}</textarea>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12">
                      ...
                      >
                        ...
                        @foreach($perangkat as $item)
                          <option
                            value="{{ $item->id }}"
                            {{ $keteranganPenghasilan->perangkat_id == $item->id ? 'selected' : '' }}
                          >
