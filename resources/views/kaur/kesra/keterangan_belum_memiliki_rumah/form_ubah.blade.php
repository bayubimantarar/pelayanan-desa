    ...
    <div class="col-lg-12">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <div class="row">
            <div class="col-lg-12">
              <form action="/dasbor/kaur-kesra/keterangan-belum-memiliki-rumah/ubah/{{ $keteranganBelumMemilikiRumah->id }}" method="post">
                <h4>
                  <b>
                    IDENTITAS PENDUDUK
                  </b>
                ...
                @section('nik')
                  <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="form-group {{ $errors->has('penduduk_id') ? 'has-error has-feedback' : '' }}">
                      ...
                      >
                        <option
                          value="{{ $keteranganBelumMemilikiRumah->penduduk->nik }}"
                          selected="selected"
                        >
                          {{ $keteranganBelumMemilikiRumah->penduduk->nik }}
                        </option>
                      </select>
                    </div>
                  </div>
