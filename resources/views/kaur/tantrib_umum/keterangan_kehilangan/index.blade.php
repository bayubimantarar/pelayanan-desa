...
@section('content')
  <div class="row">
    <div class="col-lg-12">
      <h1 class="page-header">Keterangan Kehilangan</h1>
    </div>
  </div>
  <div class="row">
    <div class="col-lg-12">
      <p>
        <a href="/kaur-tantrib-dan-umum/keterangan-kehilangan/form-tambah" class="btn btn-sm btn-primary">
          <i class="fa fa-plus"></i> Tambah Data Keterangan Bersih Diri
        </a>
      </p>
      <div class="panel panel-default">
        <div class="panel-heading">
          Tabel Data Keterangan Kehilangan
        </div>
        <div class="panel-body">
          <div class="table-responsive">
            <table
              ...
              id="keterangan-kehilangan-table"
            >
              <thead>
                <tr>
                  <th>NIK</th>
...
@section('js')
  ...
  ></script>
  <script>
    var keterangan_kehilangan = $('#keterangan-kehilangan-table').DataTable({
      ajax: {
        url: '/kaur-tantrib-dan-umum/keterangan-kehilangan/data',
        type: 'get'
      },
      datatype: 'json',
      columns: [
