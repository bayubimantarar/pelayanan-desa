  ...
  <div class="row">
    <div class="col-lg-12">
      <ul class="breadcrumb">
        ...
        <li><a href="/master/jenis-kelamin">Master - Jenis Kelamin</a></li>
    ...
    <div class="col-lg-12">
      <div class="panel panel-default">
        <div class="panel-heading">
          Form Ubah Data Jenis Kelamin
        </div>
        <div class="panel-body">
          <div class="row">
              <div class="col-lg-12">
                <form action="/dasbor/master/jenis-kelamin/ubah/{{ $jenisKelamin->id }}" method="post">
                  <input
                    type="hidden"
                    name="_method"
                    value="put"
