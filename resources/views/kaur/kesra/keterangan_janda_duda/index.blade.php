  ...
  <div class="row">
    <div class="col-lg-12">
      <ul class="breadcrumb">
        ...
        <li class="active">KAUR Kesra - Keterangan Janda Duda</li>
      </ul>
    </div>
  </div>
  <div class="row">
    <div class="col-lg-12">
      ...
      <p>
        <a
          href="/dasbor/kaur-kesra/keterangan-janda-duda/form-tambah"
        ...
        <div class="panel-body">
          <div class="table-responsive">
            <table
              ...
              id="keterangan-janda-duda-table"
            >
              <thead>
                <tr>
                  <th>NIK</th>
...
@section('js')
  ...
  ></script>
  <script>
    var keterangan_janda_duda = $('#keterangan-janda-duda-table').DataTable({
      ajax: {
        url: '/dasbor/kaur-kesra/keterangan-janda-duda/data',
        type: 'get'
      },
      datatype: 'json',
      columns: [
