  ...
  <div class="row">
    <div class="col-lg-12">
      <ul class="breadcrumb">
        ...
        <li class="active">KAUR Kesra - Keterangan Kelahiran</li>
      </ul>
    </div>
  </div>
  <div class="row">
    <div class="col-lg-12">
      ...
      <p>
        <a
          href="/dasbor/kaur-kesra/keterangan-kelahiran/form-tambah"
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          Tabel Data Keterangan Kelahiran
        </div>
...
@section('js')
  ...
  ></script>
  <script>
    var keterangan_kelahiran = $('#keterangan-kelahiran-table').DataTable({
      ajax: {
        url: '/dasbor/kaur-kesra/keterangan-kelahiran/data',
        type: 'get'
      },
      datatype: 'json',
      columns: [
