  ...
  <div class="row">
    <div class="col-lg-12">
      <ul class="breadcrumb">
        ...
        <li><a href="#">KAUR Pemerintahan - Kartu Tanda Penduduk Sementara</a></li>
            ...
            <div class="col-lg-12">
              <form action="/dasbor/kaur-pemerintahan/keterangan-ktp-sementara/ubah/{{ $keteranganKTPSementara->id }}" method="post">
                ...
                <input
                  ...
                  value="{{ $keteranganKTPSementara->penduduk_id }}"
                />
                @section('nik')
                  <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="form-group {{ $errors->has('penduduk_id') ? 'has-error has-feedback' : '' }}">
                      ...
                      >
                        <option
                          value="{{ $keteranganKTPSementara->penduduk->nik }}"
                          selected="selected"
                        >
                          {{ $keteranganKTPSementara->penduduk->nik }}
                        </option>
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-lg-12 col-md-12 col-xs-12">
                      ...
                      <textarea
                        ...
                        rows="5"
                        readonly
                      >{{ $keteranganKTPSementara->redaksi }}</textarea>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12">
                      ...
                      >
                        ...
                        @foreach($perangkat as $item)
                          <option
                            value="{{ $item->id }}"
                            {{ $keteranganKTPSementara->perangkat_id == $item->id ? 'selected' : '' }}
                          >
