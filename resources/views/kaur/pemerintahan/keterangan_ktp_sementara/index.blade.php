  ...
  <div class="row">
    <div class="col-lg-12">
      <ul class="breadcrumb">
        ...
        <li class="active">KAUR Pemerintahan - Kartu Tanda Penduduk Sementara</li>
      </ul>
    </div>
  </div>
  <div class="row">
    <div class="col-lg-12">
      ...
      <p>
        <a
          href="/dasbor/kaur-pemerintahan/keterangan-ktp-sementara/form-tambah"
...
@section('js')
  ...
  <script>
    var keterangan_ktp_sementara = $('#keterangan-ktp-sementara').DataTable({
      ajax: {
        url: '/dasbor/kaur-pemerintahan/keterangan-ktp-sementara/data',
        type: 'get'
      },
      datatype: 'json',
      columns: [
